...
##do 
    ...
    curl -H "Accept: application/json" -H "Content-type: application/json" -X POST -d '{"temp_out": 27.0, "temp_in": 28.0, "humidity_out": 40, "humidity_in": 45, "pump_status": 0}' http://localhost:3000/measures
