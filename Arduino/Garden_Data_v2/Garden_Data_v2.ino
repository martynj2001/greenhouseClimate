...
// Generated from : tree-2.jpg
// Time generated : Sun, 19 Apr 20 16:41:56 +0200  (Server timezone: CET)
// Image Size     : 40x42 pixels
...
const unsigned long GETInterval = 20000; // delay between updates, in milliseconds
...
void setup()
{
  ...
  myGLCD.print("Garden Data v1.0", CENTER, 8);
...
void loop()
{
  ...
  //Control screen
  if ((temp_out != t_temp_out) || (temp_in != t_temp_in)){
    myGLCD.setFont(SmallFont);
    myGLCD.clrScr();
...
void getSensorData()
{
  ...
  Serial.print("t_temp_out = ");
  Serial.println(t_temp_out);
  Serial.print("temp_out = ");
  Serial.println(temp_out);
  Serial.print("t_temp_in = ");
  Serial.println(t_temp_in);
