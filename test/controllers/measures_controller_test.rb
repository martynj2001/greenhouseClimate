...
class MeasuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post measures_url, params: { measure: { temp_in: @measure.temp_in, temp_out: @measure.temp_out } }
    end
  ...
  test "should update measure" do
    patch measure_url(@measure), params: { measure: { temp_in: @measure.temp_in, temp_out: @measure.temp_out } }
